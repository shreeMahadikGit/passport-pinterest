 ...
 * Examples:
 *
 *     var pinterest = require('passport-pinterest-shree');
 *
...
function Strategy(options, verify) {
    ...
    options.tokenURL = options.tokenURL || 'https://www.pinterest.com//v1/oauth/token';
    ...
    this._profileURL = options.profileURL || 'https://www.pinterest.com//v1/me/?fields=id,username,first_name,last_name,bio,created_at,url,image[30x30,60x60,110x110,165x165,280x280]';
