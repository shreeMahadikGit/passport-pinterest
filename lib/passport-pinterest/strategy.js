...
/*  options.requestTokenURL = options.requestTokenURL || 'https://www.pinterest.com/oauth/' ; //|| 'https://www.google.com/accounts/OAuthGetRequestToken';
  options.accessTokenURL = options.accessTokenURL  || 'https://www.pinterest.com/v5/oauth/token'//|| 'https://www.google.com/accounts/OAuthGetAccessToken';
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://www.google.com/accounts/OAuthAuthorizeToken';
  options.sessionKey = options.sessionKey || 'oauth:pinterest';*/

function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL =
        options.authorizationURL || "https://www.pinterest.com/oauth"; // || 'https://accounts.google.com/o/oauth2/auth';
    options.tokenURL =
        options.tokenURL || "https://www.pinterest.com/v5/oauth/token"; //|| 'https://accounts.google.com/o/oauth2/token';
...
Strategy.prototype.userProfile = function (accessToken, done) {
    ...
    console.log("the err in finding userProfile -->", err);
    console.log("the accessToken in finding userProfile -->", accessToken);
    this._oauth2.get(
        "https://www.pinterest.com/v5/me/?access_token=" + accessToken,
        accessToken,
